...
('Web Development 101', 'Farheen Arshad', 2023, TRUE, 500.00, 'XYZ');

-- Step 4.1: Select all books published after 2000
SELECT * 
FROM books
WHERE year_published > 2000;

-- Step 4.2: Select books with price < 599.00, ordered by price DESC
SELECT * 
FROM books
WHERE price < 599.00
ORDER BY price DESC;

-- Step 4.3: Select top 3 most expensive books
SELECT * 
FROM books
ORDER BY price DESC
LIMIT 3;

-- Step 4.4: Select 2 books, skipping the first 2, ordered by year_published DESC
SELECT * 
FROM books
...
-- Step 4.5: Select all books of publication 'XYZ' ordered by title ASC
SELECT * 
FROM books
